def unique_houses(filename):
    ...
    houses = set(line.rstrip().split("|")[2] for line in my_file if len(line.rstrip().split("|")[2]) > 0)
    my_file.close()
    return houses
...
def sort_by_cohort(filename):
    ...
    # winter_16.append(line.split("|")[0] + line.split("|")[1] for line in my_file if line.split("|")[4] == "Winter 2016")
    winter_16.sort()
    # spring_16.append(line.split("|")[0] + line.split("|")[1] for line in my_file if line.split("|")[4] == "Spring 2016")
    spring_16.sort()
    # summer_16.append(line.split("|")[0] + line.split("|")[1] for line in my_file if line.split("|")[4] == "Summer 2016")
    summer_16.sort()
    # fall_15.append(line.split("|")[0] + line.split("|")[1] for line in my_file if line.split("|")[4] == "Fall 2015")
    fall_15.sort()
    # ghosts.append(line.split("|")[0] + line.split("|")[1] for line in my_file if len(line.split("|")[2]) == 0)
    ghosts.sort()
...
def students_by_house(filename):
    ...
    all_hogwarts = [gryffindor] + [slytherin] + [ravenclaw] + [hufflepuff] + [dumbledores_army] + [instructors] + [ghosts]
